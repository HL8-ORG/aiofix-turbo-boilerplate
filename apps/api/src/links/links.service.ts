...
import { Link } from '@pkg/api/links/entities/link.entity';

import { CreateLinkDto } from '@pkg/api/links/dto/create-link.dto';
import { UpdateLinkDto } from '@pkg/api/links/dto/update-link.dto';
